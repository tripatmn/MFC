#!/usr/bin/env python3
"""High-grid clean nonreacting dodecane evaporation validation case."""
...
parser = argparse.ArgumentParser(prog="2D_dodecane_clean_evap_validation_high")
...
case = build_evap_validation_case(256)
