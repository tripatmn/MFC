#!/usr/bin/env python3
"""Ultralean-output high-grid clean baseline dodecane burning validation case."""
...
parser = argparse.ArgumentParser(prog="2D_dodecane_clean_burning_validation_high_ultralean")
...
case = apply_ultralean_output(add_baseline_burning(build_evap_validation_case(256), CTFILE))
