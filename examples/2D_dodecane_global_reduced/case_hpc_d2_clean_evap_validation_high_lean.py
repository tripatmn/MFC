#!/usr/bin/env python3
"""Lean-output high-grid clean nonreacting dodecane evaporation validation case."""
...
parser = argparse.ArgumentParser(prog="2D_dodecane_clean_evap_validation_high_lean")
...
case = apply_lean_output(build_evap_validation_case(256))
