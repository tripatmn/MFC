#!/usr/bin/env python3
"""Tanabe-1996-style 0.7 mm n-dodecane autoignition scout case.

Target condition:
  * n-dodecane droplet, D0 = 0.7 mm
  * air, p0 = 2.0 MPa, T_gas = 800 K
  * Yao/SK54 finite-rate chemistry

This preserves the cold-liquid / hot-ambient pattern used by the existing
quiescent evaporation and Frolov bridge cases. The liquid is represented by the
stiffened-liquid density/pressure state; the gas/vapor trace fields use the
800 K ambient density. MFC's case format does not provide a separate explicit
liquid temperature IC in this model-3 setup.
"""
...
parser = argparse.ArgumentParser(prog="2D_dodecane_tanabe1996_070mm_P20bar_T800_yao_sk54_128")
...
base.cells_per_diameter = 128/6.0
base.nx = 128
base.ny = 128
...
if __name__ == "__main__":
    print(
        "Tanabe 1996 Yao/SK54 128 scout: "
