#!/usr/bin/env python3
"""High-grid clean baseline dodecane burning validation case."""
...
parser = argparse.ArgumentParser(prog="2D_dodecane_clean_burning_validation_high")
...
case = add_baseline_burning(build_evap_validation_case(256), CTFILE)
