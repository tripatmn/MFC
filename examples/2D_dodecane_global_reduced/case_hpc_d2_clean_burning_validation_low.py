#!/usr/bin/env python3
"""Low-grid clean baseline dodecane burning validation case."""
...
parser = argparse.ArgumentParser(prog="2D_dodecane_clean_burning_validation_low")
...
case = add_baseline_burning(build_evap_validation_case(128), CTFILE)
