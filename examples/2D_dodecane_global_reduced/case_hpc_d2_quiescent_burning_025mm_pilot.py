#!/usr/bin/env python3
"""0.25 mm quiescent n-dodecane burning pilot with reaction heat."""
...
parser = argparse.ArgumentParser(prog="2D_dodecane_quiescent_burning_025mm_pilot")
    ...
    for start in starts:
        for path in (start, *start.parents):
            ...
            if (
                ...
                return path
    raise RuntimeError("Could not find MFC repo root with 0.25 mm pilot inputs.")
...
from case_hpc_d2_quiescent_evap_025mm_pilot import build_case
