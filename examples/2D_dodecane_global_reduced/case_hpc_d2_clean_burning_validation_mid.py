#!/usr/bin/env python3
"""Mid-grid clean baseline dodecane burning validation case."""
...
parser = argparse.ArgumentParser(prog="2D_dodecane_clean_burning_validation_mid")
...
case = add_baseline_burning(build_evap_validation_case(192), CTFILE)
