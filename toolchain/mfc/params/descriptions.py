...
DESCRIPTIONS = {
    ...
    "chem_fixed_T_enable": "Enable validation-only fixed chemistry temperature for multi-fluid cases",
    "chem_fixed_T": "Validation-only fixed chemistry temperature",
    "chem_T_min": "Minimum temperature passed to chemistry source terms",
    "chem_T_max": "Maximum temperature passed to chemistry source terms",
    ...
    "fuel_species_id": "Species equation index for evaporation-to-species coupling",
    "evap_species_source": "Enable evaporation-gated species source hook",
    "evap_species_src": "Species source value in cells inside the liquid interface band",
    "evap_liquid_fluid_id": "Fluid index used to detect liquid volume fraction for species source",
    "evap_alpha_thresh": "Liquid volume-fraction threshold for enabling evaporation species source",
    "evap_alpha_lo": "Lower liquid volume-fraction bound for enabling evaporation species source",
    "evap_alpha_hi": "Upper liquid volume-fraction bound for enabling evaporation species source",
    "evap_species_alpha_min": "Minimum gas volume fraction for evaporation-to-species coupling",
    "evap_species_mass_min": "Minimum gas alpha-rho for evaporation-to-species coupling",
    "evap_species_liq_max": "Maximum liquid volume fraction for evaporation-to-species coupling",
