#!/usr/bin/env python3
"""C4: standalone SK54 Mach-3 shock/droplet case, diffusion ON, reactions ON, 5.0 us.

Resolved from the successful C2 generated inputs, with a supported stretched
20 mm x grid; imports only json and has no dependency on sibling run folders.
"""
...
case = {
    ...
    'patch_icpp(1)%x_centroid': 0.0102,
    'patch_icpp(1)%y_centroid': 0.00030000000000000003,
    'patch_icpp(1)%length_x': 0.0196,
