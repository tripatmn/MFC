#!/usr/bin/env python3
"""C4 diagnostic: 100 um gas-phase NC12H26 vapor bubble, 10 us.

Derived from runs/shockdroplet_air_sk54/alpha_source_fix/
C4_long_domain_restartable_base_2p0us/case.py.

Purpose: isolate gas-phase fuel/oxidizer mixing and chemistry without liquid
phase-change inventory coupling.  The model-3 three-fluid layout is retained,
but liquid volume fraction and liquid partial density are initialized to zero in
all patches.  The circular 100 um patch is pressure- and temperature-matched to
the local pre-shock ambient gas state and filled with NC12H26 vapor plus the
same trace air content used by C4.  Phase-change relaxation and the evaporation
species hook are disabled; chemistry and molecular diffusion remain enabled.
"""
...
case = {'chemistry': 'T',
 ...
 'patch_icpp(3)%alpha(2)': 0.999985,
 'patch_icpp(3)%alpha(3)': 1.5e-05,
 'patch_icpp(3)%alpha_rho(1)': 0.0,
 'patch_icpp(3)%alpha_rho(2)': 4.334842695151079,
 ...
 'patch_icpp(3)%Y(1)': 1.9034781205963467e-06,
 ...
 'patch_icpp(3)%Y(10)': 5.779467187562096e-07,
 ...
 'patch_icpp(3)%Y(46)': 0.9999975185751606,
