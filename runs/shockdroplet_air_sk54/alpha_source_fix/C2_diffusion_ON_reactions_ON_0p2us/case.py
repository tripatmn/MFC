#!/usr/bin/env python3
"""C2: SK54 Mach-3 shock/droplet, diffusion ON, reactions ON, 0.2 us."""
...
# Short diffusion+reaction test interval; keep the established saved-state cadence.
case["t_stop"] = 2.0e-7
case["t_save"] = 5.0e-8
case["t_step_print"] = 50

# Chemistry species machinery, diffusion, reactions, and reaction heat are active.
case["chemistry"] = "T"
