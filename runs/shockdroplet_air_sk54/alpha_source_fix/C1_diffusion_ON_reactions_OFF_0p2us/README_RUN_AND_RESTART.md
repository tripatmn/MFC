...
Purpose: isolate SK54 species diffusion with reactions and chemical heat release OFF through 0.2 µs.
...
Do not set `TEMP_CHEM_SPECIES_COUPLED_SOURCE_LIMIT`; reactions are OFF.
