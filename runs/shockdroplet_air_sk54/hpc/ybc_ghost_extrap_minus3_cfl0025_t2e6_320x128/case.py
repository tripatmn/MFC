...
This guarded variant enables the evaporation-to-fuel species source only in
cells with meaningful gas/vapor presence, avoiding near-pure-liquid and
gas-empty interface cells.
"""
